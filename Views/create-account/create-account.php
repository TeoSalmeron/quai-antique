...
<main id="create-account-main">
    ...
    <form action="" method="post" id="createAccountForm">
        <input type="text" name="last_name" id="userLastName" placeholder="Nom de famille">
        <input type="text" name="first_name" id="userFirstName" placeholder="Prénom">
        <input type="text" name="email" id="userEmail" placeholder="E-mail">
        <input type="text" name="phone" id="userPhone" placeholder="Numéro de téléphone">
        <small>Format : 00.00.00.00.00</small>
        <select name="default_nb_guest" id="userDefaultNbGuest" placeholder="Nombres de couverts par défaut">
        ...
        <div class="form_box">
            ...
            <input type="radio" name="prompt_allergy" id="noAllergy" value="0">
            <label for="noAllergy" class="no_border">Non</label>
        </div>
        <div class="form_allergies">
            <?php
